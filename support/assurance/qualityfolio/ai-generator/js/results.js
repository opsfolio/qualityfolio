...
async function saveResults() {
  if (generatedTestCases) {
    console.log("saveResults", generatedTestCases)
  ...
  strategies.forEach((strat) => {
    ...
    plans.forEach((plan) => {
      ...
      if (level === "5" || level === "6") {
        ...
        md += `${pDepth} ${plan.planName}\n\n@id ${plan.planId || plan.id || "PLAN-001"}\n\n`;
      ...
      suites.forEach((suite) => {
        ...
        if (level === "4" || level === "5" || level === "6") {
          ...
          md += `${sDepth} ${suite.suiteName}\n\n@id ${suite.suiteId || suite.id || "SUITE-001"}\n\n`;
...
//   if (generatedTestCases) {
//     console.log("qf_generated_test_cases", generatedTestCases)
//     localStorage.setItem(
//       "qf_generated_test_cases",
//       JSON.stringify(generatedTestCases),
//     );
